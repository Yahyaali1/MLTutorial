...
# Random forest takes a random ssample set of point and form a tree around it.
# Follows same steps to form several tress specified
# Predicts the new points based on the majority vote answer of all the forest that is formed 
